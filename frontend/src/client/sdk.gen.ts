...
import type {
  ...
  EventsNewEventData,
  EventsNewEventResponse,
  EventsEditEventData,
  EventsEditEventResponse,
  EventsGetEventData,
  EventsGetEventResponse,
  EventsEventStatsData,
  EventsEventStatsResponse,
  EventsGenerateSlideResponse,
  ItemsReadItemsData,
  ...
  QuestionsListQuestionsData,
  QuestionsListQuestionsResponse,
  ...
  QuestionsLikeQuestionData,
  QuestionsLikeQuestionResponse,
  UsersReadUsersData,
...
export class EventsService {
  ...
  public static newEvent(
    data: EventsNewEventData,
  ): CancelablePromise<EventsNewEventResponse> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/events/",
  ...
  public static editEvent(
    data: EventsEditEventData,
  ): CancelablePromise<EventsEditEventResponse> {
    return __request(OpenAPI, {
      method: "PUT",
  ...
  public static getEvent(
    data: EventsGetEventData,
  ): CancelablePromise<EventsGetEventResponse> {
    return __request(OpenAPI, {
      method: "GET",
  ...
  public static eventStats(
    data: EventsEventStatsData,
  ): CancelablePromise<EventsEventStatsResponse> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/v1/events/{id}/stats",
      path: {
        id: data.id,
      },
      errors: {
   ...
   * @throws ApiError
   */
  public static generateSlide(): CancelablePromise<EventsGenerateSlideResponse> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/events/{uuid}/slide.jpg",
    })
  }
}
...
export class QuestionsService {
  /**
   * List Questions
   * List all questions for an event with optional sorting and filtering
   * @param data The data for the request.
   * @param data.eventId
   * @param data.sortBy
   * @param data.order
  ...
  public static listQuestions(
    data: QuestionsListQuestionsData,
  ): CancelablePromise<QuestionsListQuestionsResponse> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/v1/questions/events/{event_id}/questions",
      path: {
  ...
  /**
   * Create Question
   * Create new question for an event
   * @param data The data for the request.
   * @param data.eventId
   * @param data.userName
   * @param data.attendeeIdentifier
   * @param data.requestBody
   * @param data.parentId
  ...
  public static createQuestion(
    ...
    return __request(OpenAPI, {
      ...
      query: {
        ...
        attendee_identifier: data.attendeeIdentifier,
        parent_id: data.parentId,
      },
      body: data.requestBody,
      mediaType: "application/json",
  ...
  public static updateQuestion(
    ...
    return __request(OpenAPI, {
      method: "PUT",
      url: "/api/v1/questions/events/{event_id}/questions/{id}",
      path: {
        event_id: data.eventId,
        id: data.id,
      },
   ...
   * @throws ApiError
   */
  public static likeQuestion(
    data: QuestionsLikeQuestionData,
  ): CancelablePromise<QuestionsLikeQuestionResponse> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/v1/questions/events/{event_id}/questions/{id}/like",
      path: {
        event_id: data.eventId,
        id: data.id,
      },
